        ...
        return(
            <section id="extra">
                ...
                <CustomCollapsible ButtonClassName="Color3" Name="Learning to code">
                    ...
                    It was just felt like a huge case of imposter syndrome, even after I had been told that the fellowship had in some way been proven successful by evidence of my progression as a developer.
                    I found it so troublesome, or strange rather, largely due to the lack of confidence I had in my abilities. Looking back at the first few months, I think I am absolutely correct in stating that I was a terrible coder, simply because I just straight up did not know how to do a lot of things. But I had the persistence, the patience, and the passion to keep trying. Since then, I've improved by an immense measure, learned better techniques, developed an inquisitive mind, and began discovering what sort of engineer and developer I want to be.
                    </p>
                </CustomCollapsible>
                ...
                <CustomCollapsible ButtonClassName="Color5" Name="Developing a career in tech">
                    ...
                    So I’d love to connect with you, especially since you have stuck with me to the end. So please shoot me an <a href="mailto:kellyjung96@gmail.com" target="_blank" rel="noopener noreferrer">email</a> or <a href="[https://www.linkedin.com/in/kellysjung](https://www.linkedin.com/in/kellysjung)" target="_blank" rel="noopener noreferrer">connect with me on LinkedIn</a>!
                    </p>
                </CustomCollapsible>
            </section>
        );
