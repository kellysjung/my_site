        ...
        return(
            <section id="extra">
                ...
                <CustomCollapsible ButtonClassName="Color5" Name="Developing a career in tech">
                    ...
                    <p>
                    So then, where do I go on from here? I'm not exactly sure, but I know I want to at least continue doing something similar to what I am doing right now, which building my skills as a well-rounded software engineer. Yes, my experiences have mostly been in front-end web dev projects, since I very much enjoy seeing the outlook of software, and changing the UX, but I'm always open to learning to do new things. And I believe that my growth since becoming a full time Software Engineer has really showcased my ability to learn quickly and efficiently.
                    </p><p>
                    ...
                    So I’d love to connect with you. So please shoot me an <a href="mailto:kellyjung96@gmail.com" target="_blank" rel="noopener noreferrer">email</a> or <a href="[https://www.linkedin.com/in/kellysjung](https://www.linkedin.com/in/kellysjung)" target="_blank" rel="noopener noreferrer">connect with me on LinkedIn</a>!
                    </p><p>
                    Thank you for sticking with me as I recounted this little journey in a long and winded manner. I’ve recently read two memoirs, and so I think that’s the reason why I feel compelled to write like this.
                    </p>
                </CustomCollapsible>
            </section>
        );
